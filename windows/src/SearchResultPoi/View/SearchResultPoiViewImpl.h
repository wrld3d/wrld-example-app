...
namespace ExampleApp
{
    namespace SearchResultPoi
    {
        namespace View
        {
            class SearchResultPoiViewImpl : public ISearchResultPoiView, Eegeo::NonCopyable
            {
            private:
            ...
            public:
                SearchResultPoiViewImpl(const std::shared_ptr<WindowsNativeState>& nativeState);

                ~SearchResultPoiViewImpl();
