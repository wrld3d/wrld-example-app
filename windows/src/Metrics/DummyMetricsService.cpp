...
namespace ExampleApp
{
    namespace Metrics
    {
        ...
        void DummyMetricsService::BeginSession(const std::string& apiKey, const std::string& appVersion)
        {
            m_enabled = true;
        }

        void DummyMetricsService::SetPosition(double latitude, double longitude, double horizAccuracy, double vertAccuracy)
        {
        }
        ...
        void DummyMetricsService::BeginTimedEvent(const std::string& eventString, const std::string& key1, const std::string& value1)
        {
        }
        ...
        void DummyMetricsService::EndTimedEvent(const std::string& eventString, const std::string& key1, const std::string& value1)
        {
        }
