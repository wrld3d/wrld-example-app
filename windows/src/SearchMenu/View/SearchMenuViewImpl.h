...
namespace ExampleApp
{
    namespace SearchMenu
    {
        namespace View
        {
            class SearchMenuViewImpl : public Menu::View::MenuViewImpl, public SearchMenu::View::ISearchMenuView
            {
            private:
            ...
            public:
                SearchMenuViewImpl(const std::shared_ptr<WindowsNativeState>& nativeState,
