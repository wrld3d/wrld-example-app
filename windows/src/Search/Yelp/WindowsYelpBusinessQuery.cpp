...
namespace ExampleApp
{
    namespace Search
    {
        namespace Yelp
        {
            WindowsYelpBusinessQuery::WindowsYelpBusinessQuery(
                ...
                , m_isSuccess(false)
            {
                ...
                jstring strClassName = env->NewStringUTF("com/eegeo/search/yelp/WindowsYelpSearchQuery");
            ...
            void WindowsYelpBusinessQuery::Dispatch()
            {
                ASSERT_NATIVE_THREAD

                    Eegeo_ASSERT(!m_dispatched, "Cannot dispatch WindowsYelpBusinessQuery if query has already been dispatched.\n");
                m_dispatched = true;
            ...
            void WindowsYelpBusinessQuery::Cancel()
            {
                ASSERT_NATIVE_THREAD
            ...
            void WindowsYelpBusinessQuery::HandleQueryCompleted(bool success, const std::string& queryResult)
            {
                ASSERT_NATIVE_THREAD
            ...
            bool WindowsYelpBusinessQuery::IsSucceeded()
            {
                ASSERT_NATIVE_THREAD
            ...
            const std::string& WindowsYelpBusinessQuery::ResponseString()
            {
                ASSERT_NATIVE_THREAD
