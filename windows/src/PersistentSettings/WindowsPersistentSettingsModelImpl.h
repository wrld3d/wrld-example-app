...
namespace ExampleApp
{
    ...
    {
        class WindowsPersistentSettingsModelImpl : public IPersistentSettingsModel, private Eegeo::NonCopyable
        {
        ...
        public:
            WindowsPersistentSettingsModelImpl(const std::shared_ptr<WindowsNativeState>& nativeState);

            ~WindowsPersistentSettingsModelImpl();
