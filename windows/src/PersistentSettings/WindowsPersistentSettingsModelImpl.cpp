...
namespace ExampleApp
{
    ...
    {
        WindowsPersistentSettingsModelImpl::WindowsPersistentSettingsModelImpl(const std::shared_ptr<WindowsNativeState>& nativeState)
        ...
        WindowsPersistentSettingsModelImpl::~WindowsPersistentSettingsModelImpl()
        {
            ASSERT_NATIVE_THREAD
        }

        bool WindowsPersistentSettingsModelImpl::TryGetValue(const std::string& name, bool& out_value) const
        {
			ASSERT_NATIVE_THREAD
        ...
        bool WindowsPersistentSettingsModelImpl::TryGetValue(const std::string& name, int& out_value) const
        {
            ASSERT_NATIVE_THREAD
        ...
        bool WindowsPersistentSettingsModelImpl::TryGetValue(const std::string& name, double& out_value) const
        {
            ASSERT_NATIVE_THREAD
        ...
        bool WindowsPersistentSettingsModelImpl::TryGetValue(const std::string& name, std::string& out_value) const
        {
            ASSERT_NATIVE_THREAD
        ...
        void WindowsPersistentSettingsModelImpl::SetValue(const std::string& name, bool value)
        {
			ASSERT_NATIVE_THREAD
        ...
        void WindowsPersistentSettingsModelImpl::SetValue(const std::string& name, int value)
        {
            ASSERT_NATIVE_THREAD
        ...
        void WindowsPersistentSettingsModelImpl::SetValue(const std::string& name, double value)
        {
            ASSERT_NATIVE_THREAD
        ...
        void WindowsPersistentSettingsModelImpl::SetValue(const std::string& name, const std::string& value)
        {
            ASSERT_NATIVE_THREAD
        ...
        void WindowsPersistentSettingsModelImpl::ClearAll()
        {
			ASSERT_NATIVE_THREAD
        ...
        bool WindowsPersistentSettingsModelImpl::HasValue(const std::string& name) const
        {
