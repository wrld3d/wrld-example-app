...
nuget.exe restore ExampleApp\ExampleApp.sln
"%VCTargetsPath%\..\..\..\14.0\Bin\msbuild" ExampleApp\ExampleApp.sln /p:Configuration=Release /p:Platform=x64 /t:Clean
"%VCTargetsPath%\..\..\..\14.0\Bin\msbuild" ExampleApp\ExampleApp.sln /p:Configuration=Release /p:Platform=x64 /target:ExampleAppWPF
