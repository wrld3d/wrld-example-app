...
namespace ExampleApp
{
    namespace IndoorAtlas
    {
        ...
        private:
            ...
            Eegeo::Helpers::TCallback1<IndoorAtlasLocationService, const ExampleApp::InteriorsPosition::InteriorsPositionLocationChangedMessage&> m_locationChangeCallback;
        };
    }
}
