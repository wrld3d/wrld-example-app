...
namespace ExampleApp
{
    namespace IndoorAtlas
    {
        ...
        bool IndoorAtlasLocationService::GetAltitude(double& altitude)
        {
            ...
            if (interiorModel)
            {
                altitude = ExampleApp::Helpers::InteriorHeightHelpers::GetFloorHeightAboveSeaLevelIncludingEnvironmentFlattening(*interiorModel, m_floorIndex, m_environmentFlatteningService.GetCurrentScale());
                return true;
            }
        ...
        void IndoorAtlasLocationService::OnLocationChanged(const ExampleApp::InteriorsPosition::InteriorsPositionLocationChangedMessage& locationChangedMessage)
        {
