    ...
    namespace Search
    {
        namespace SdkModel
        {
            ...
            public:
                ...
                virtual void InsertOnReceivedQueryResultsCallback(Eegeo::Helpers::ICallback3<const bool&, const SearchQuery&, const std::vector<SearchResultModel>& >& callback) = 0;

                virtual void RemoveOnReceivedQueryResultsCallback(Eegeo::Helpers::ICallback3<const bool&, const SearchQuery&, const std::vector<SearchResultModel>& >& callback) = 0;
            };
        }
    }
}
