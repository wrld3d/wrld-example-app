...
namespace ExampleApp
{
    namespace Search
    {
        namespace Swallow
        {
            namespace View
            {
                class SwallowOfficeResultMenuOption: public Menu::View::IMenuOption, private Eegeo::NonCopyable
                {
                    std::string m_name;
                ...
                public:
                    SwallowOfficeResultMenuOption(const std::string& name,
