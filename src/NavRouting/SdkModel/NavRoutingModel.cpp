...
namespace ExampleApp
{
    namespace NavRouting
    {
        namespace SdkModel
        {
            ...
            void NavRoutingModel::SetStartLocation(const SdkModel::NavRoutingLocationModel& locationModel)
            {
            ...
            bool NavRoutingModel::TryGetStartLocation(SdkModel::NavRoutingLocationModel &out_startLocation) const
            {
            ...
            void NavRoutingModel::SetEndLocation(const SdkModel::NavRoutingLocationModel& locationModel)
            {
            ...
            bool NavRoutingModel::TryGetEndLocation(SdkModel::NavRoutingLocationModel &out_endLocation) const
            {
            ...
            void NavRoutingModel::SetRoute(const SdkModel::NavRoutingRouteModel& routeModel)
            {
                m_route = routeModel;
                m_routeIsSet = true;
            ...
            bool NavRoutingModel::TryGetRoute(SdkModel::NavRoutingRouteModel &out_routeModel) const
            {
                if (m_routeIsSet)
                {
            ...
            void NavRoutingModel::InsertStartLocationSetCallback(Eegeo::Helpers::ICallback1<const SdkModel::NavRoutingLocationModel&>& startLocationSetCallback)
            {
                m_startLocationSetCallbacks.AddCallback(startLocationSetCallback);
            }

            void NavRoutingModel::RemoveStartLocationSetCallback(Eegeo::Helpers::ICallback1<const SdkModel::NavRoutingLocationModel&>& startLocationSetCallback)
            {
            ...
            void NavRoutingModel::InsertEndLocationSetCallback(Eegeo::Helpers::ICallback1<const SdkModel::NavRoutingLocationModel&>& endLocationSetCallback)
            {
                m_endLocationSetCallbacks.AddCallback(endLocationSetCallback);
            }

            void NavRoutingModel::RemoveEndLocationSetCallback(Eegeo::Helpers::ICallback1<const SdkModel::NavRoutingLocationModel&>& endLocationSetCallback)
            {
            ...
            void NavRoutingModel::InsertRouteSetCallback(Eegeo::Helpers::ICallback1<const SdkModel::NavRoutingRouteModel&>& routeSetCallback)
            {
                m_routeSetCallbacks.AddCallback(routeSetCallback);
            }

            void NavRoutingModel::RemoveRouteSetCallback(Eegeo::Helpers::ICallback1<const SdkModel::NavRoutingRouteModel&>& routeSetCallback)
            {
