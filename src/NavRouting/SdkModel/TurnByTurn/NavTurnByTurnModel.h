        ...
        namespace SdkModel
        {
            namespace TurnByTurn
            {
                ...
                public:
                    ...
                    void InsertOnGPSLostCallback(Eegeo::Helpers::ICallback0& callback);
                    void RemoveOnGPSLostCallback(Eegeo::Helpers::ICallback0& callback);
                ...
                private:
                    ...
                    Eegeo::Helpers::CallbackCollection0 m_hasLostGPSCallbacks;
