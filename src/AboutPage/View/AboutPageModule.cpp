    ...
    namespace AboutPage
    {
        namespace View
        {
                                             ...
                                             const std::string& appName)
            {
                ...
                m_pAboutPageViewModel = Eegeo_NEW(AboutPageViewModel)(identityProvider.GetNextIdentity(), buildVersion, EEGEO_PLATFORM_VERSION_NUMBER, EEGEO_PLATFORM_VERSION_HASH, platformRuntimeArchitecture, "", appName);
            }
