...
namespace ExampleApp
{
    namespace Menu
    {
        namespace View
        {
            MenuOpenableControl::MenuOpenableControl(Eegeo::Helpers::TIdentity identity, const std::shared_ptr<Reaction::View::IReactionControllerModel>& reactionControllerModel)
