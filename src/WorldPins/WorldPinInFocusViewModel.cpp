...
namespace ExampleApp
{
	namespace WorldPins
	{
		...
		const WorldPinsInFocusModel& WorldPinInFocusViewModel::GetWorldPinsInFocusModel() const
		{
		...
		{
            IWorldPinSelectionHandler* pSelectionHandler = m_worldPinsService.GetSelectionHandlerForPin(m_worldPinInFocusModel.GetPinId());
		...
		void WorldPinInFocusViewModel::Open(const WorldPinsInFocusModel& worldPinsInFocusModel, const Eegeo::v2& screenPos)
		{
		...
		ScreenControlViewModel::IScreenControlViewModel& WorldPinInFocusViewModel::GetScreenControlViewModel()
		{
