...
namespace ExampleApp
{
    namespace WorldPins
    {
        namespace SdkModel
        {
            WorldLabelsService::WorldLabelsService(Eegeo::Labels::ILabelModelService& labelModelService,
            ...
            , m_labelHiddenFilter(this, &WorldLabelsService::LabelHiddenPredicate)
            {
                m_labelAnchorFilterModel.SetFilter(m_labelLayerId, &m_labelHiddenFilter);
            }
            
            WorldLabelsService::~WorldLabelsService()
            {
                m_labelAnchorFilterModel.SetFilter(m_labelLayerId, NULL);
            }
            
            WorldPinItemModel* WorldLabelsService::AddPin(IWorldPinSelectionHandler* pSelectionHandler,
            ...
            void WorldLabelsService::RemovePin(WorldPinItemModel* pinItemModel)
            {
            ...
            void WorldLabelsService::UpdatePinScale(const WorldPinItemModel& pinItemModel, float scale)
            {
            ...
            void WorldLabelsService::GetPinEcefAndScreenLocations(const WorldPinItemModel& pinItemModel,
            ...
            bool WorldLabelsService::HandleTouchTap(const Eegeo::v2& screenTapPoint)
            {
                return TrySelectPinAtPoint(screenTapPoint);
            }
            
            bool WorldLabelsService::HandleTouchDoubleTap(const Eegeo::v2& screenTapPoint)
            {
                return TrySelectPinAtPoint(screenTapPoint);
            }
            
            void WorldLabelsService::SelectPin(WorldPinItemModel::WorldPinItemModelId worldPinItemModelId)
            {
            ...
            void WorldLabelsService::Update(float dt)
            {
            ...
            void WorldLabelsService::Erase(const WorldPinItemModel::WorldPinItemModelId &id)
            {
            ...
            IWorldPinSelectionHandler* WorldLabelsService::GetSelectionHandlerForPin(WorldPinItemModel::WorldPinItemModelId worldPinItemModelId)
            {
            ...
            bool WorldLabelsService::TrySelectPinAtPoint(const Eegeo::v2& screenPoint)
            {
