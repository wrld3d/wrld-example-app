...
namespace ExampleApp
{
    namespace WorldPins
    {
        namespace SdkModel
        {
            ...
            void WorldPinsVisibilityController::InsertVisibilityMaskChangedCallback(Eegeo::Helpers::ICallback0& callback)
            {
                m_visibilityMaskChangedCallbacks.AddCallback(callback);
            }

            void WorldPinsVisibilityController::RemoveVisibilityMaskChangedCallback(Eegeo::Helpers::ICallback0& callback)
            {
