...
namespace ExampleApp
{
	namespace WorldPins
	{
        ...
        , m_visibilityMessageHandlerBinding(this, &WorldPinsInFocusController::HandleVisibilityChange)
        ...
        void WorldPinsInFocusController::HandleVisibilityChange(const WorldPinsVisibilityMessage &worldPinsVisibilityMessage)
        {
