...
namespace ExampleApp
{
    namespace GpsMarker
    {
        namespace SdkModel
        {
            class GpsMarkerHighlightMaterial : protected Eegeo::NonCopyable, public Eegeo::Rendering::Materials::IMaterial
            {
            public:
                GpsMarkerHighlightMaterial(const Eegeo::Rendering::TMaterialId materialId,
