...
namespace ExampleApp
{
    namespace GpsMarker
    {
        namespace SdkModel
        {
            class GpsMarkerStencilClearMaterial : protected Eegeo::NonCopyable, public Eegeo::Rendering::Materials::IMaterial
            {
            public:
                GpsMarkerStencilClearMaterial(const Eegeo::Rendering::TMaterialId materialId,
