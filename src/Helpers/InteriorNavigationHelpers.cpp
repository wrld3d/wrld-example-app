        ...
        namespace InteriorNavigationHelpers
        {
                                      ...
                                      Eegeo::Location::ILocationService& locationService)
            {
                ...
                if(locationService.GetLocation(latLong) && interiorInteractionModel.HasInteriorModel())
                {
                    ...
                    const float targetAltitude = Eegeo::Resources::Interiors::GetFloorHeightAboveSeaLevel(
                            interiorsModel, static_cast<unsigned int>(interiorInteractionModel.GetSelectedFloorIndex()));
