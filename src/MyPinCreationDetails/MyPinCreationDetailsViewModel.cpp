...
namespace ExampleApp
{
    ...
    {
        MyPinCreationDetailsViewModel::MyPinCreationDetailsViewModel(Eegeo::Helpers::TIdentity identity, Reaction::IReactionControllerModel& reactionControllerModel)
        ...
        OpenableControlViewModel::IOpenableControlViewModel& MyPinCreationDetailsViewModel::GetOpenableControl()
        {
            return m_openable;
        }
