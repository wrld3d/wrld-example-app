...
namespace ExampleApp
{
    namespace MyPinCreationDetails
    {
        namespace View
        {
            ...
            public:
                MyPinCreationDetailsOpenableControl(Eegeo::Helpers::TIdentity identity, const std::shared_ptr<Reaction::View::IReactionControllerModel>& reactionControllerModel);
