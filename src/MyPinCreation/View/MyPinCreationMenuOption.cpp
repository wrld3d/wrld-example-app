...
namespace ExampleApp
{
    namespace MyPinCreation
    {
        namespace View
        {
            MyPinCreationMenuOption::MyPinCreationMenuOption(Menu::View::IMenuViewModel& createPinContainerMenu,MyPinCreation::View::IMyPinCreationConfirmationViewModel& myPinCreationConfirmationViewModel)
