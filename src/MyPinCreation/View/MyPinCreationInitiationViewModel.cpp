...
namespace ExampleApp
{
    namespace MyPinCreation
    {
        ...
        ScreenControlViewModel::IScreenControlViewModel& MyPinCreationInitiationViewModel::GetScreenControlViewModel()
        {
        ...
        void MyPinCreationInitiationViewModel::InsertOnScreenStateChangedCallback(Eegeo::Helpers::ICallback2<ScreenControlViewModel::IScreenControlViewModel&, float>& callback)
        {
            m_screenControl.InsertOnScreenStateChangedCallback(callback);
        }
        
        void MyPinCreationInitiationViewModel::RemoveOnScreenStateChangedCallback(Eegeo::Helpers::ICallback2<ScreenControlViewModel::IScreenControlViewModel&, float>& callback)
        {
