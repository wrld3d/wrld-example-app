...
namespace ExampleApp
{
    namespace PoiCreation
    {
        namespace PoiRing
        {
            PoiRingModule::PoiRingModule(IPoiCreationModel& poiCreationModel,
            ...
            : m_renderableFilters(renderingModule.GetRenderableFilters())
            {
                ...
                m_pPoiRingController = Eegeo_NEW(PoiRingController)(poiCreationModel,
                                                                    *m_pPoiRingView,
                                                                    screenProperties);
                ...
                m_pPoiRingTouchController = Eegeo_NEW(PoiRingTouchController)(poiCreationModel, *m_pTerrainRayPicker);
            }
