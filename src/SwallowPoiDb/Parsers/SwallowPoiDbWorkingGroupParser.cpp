...
namespace ExampleApp
{
    namespace SwallowPoiDb
    {
        namespace Parsers
        {
            ...
            Search::SdkModel::SearchResultModel SwallowPoiDbWorkingGroupParser::SQLiteResultRowToSearchResult(const Eegeo::SQLite::SQLiteResultRow& resultRow, const std::string& assetsBaseUrl, int columnOffset)
            {
                rapidjson::Document jsonDoc;
                rapidjson::Document::AllocatorType& allocator = jsonDoc.GetAllocator();
                rapidjson::Value valueObject(rapidjson::kObjectType);
                
				AddStringToJson(Search::Swallow::SearchConstants::NAME_FIELD_NAME.c_str(),
                ...
                std::string modelID = Search::Swallow::SearchConstants::WORKING_GROUP_CATEGORY_NAME + std::string("_") + resultRow.Cell(columnOffset + poi_id).AsText();
            ...
            Search::SdkModel::SearchResultModel SwallowPoiDbWorkingGroupParser::SQLiteResultRowToSearchResult(const Eegeo::SQLite::SQLiteResultRow& resultRow, const std::string& assetsBaseUrl)
            {
