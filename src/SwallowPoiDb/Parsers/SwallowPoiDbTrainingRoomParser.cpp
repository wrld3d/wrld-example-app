...
namespace ExampleApp
{
    namespace SwallowPoiDb
    {
        ...
        {            
            ...
            Search::SdkModel::SearchResultModel SwallowPoiDbTrainingRoomParser::SQLiteResultRowToSearchResult(const Eegeo::SQLite::SQLiteResultRow& resultRow, const std::string& assetsBaseUrl, int columnOffset)
            {
                ...
                std::string modelID = Search::Swallow::SearchConstants::TRAINING_ROOM_CATEGORY_NAME + std::string("_") + resultRow.Cell(columnOffset + poi_id).AsText();
            ...
            Search::SdkModel::SearchResultModel SwallowPoiDbTrainingRoomParser::SQLiteResultRowToSearchResult(const Eegeo::SQLite::SQLiteResultRow& resultRow, const std::string& assetsBaseUrl)
            {
