...
namespace ExampleApp
{
    namespace SwallowPoiDb
    {
        namespace Constants
        {
            ...
            const std::string TrainingRoomTableName = "TrainingRoomPois";
            const std::string TrainingRoomFtsColumnNames[1] = { NAME_FIELD_NAME };
            const float TrainingRoomFtsColumnWeights[1] = { 1.0f };
            ...
            const std::string DepartmentTableName = "DepartmentPois";
            const std::string DepartmentFtsColumnNames[2] = { NAME_FIELD_NAME, DESCRIPTION_FIELD_NAME };
            const float DepartmentFtsColumnWeights[2] = { 1.0f, 0.5f };
