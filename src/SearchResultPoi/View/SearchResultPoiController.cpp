    ...
    namespace SearchResultPoi
    {
        ...
        {   
            void SearchResultPoiController::OnViewOpened()
            {
                ...
                Search::Yelp::TryParseImageDetails(searchResultModel, imageUrl, ratingImageUrl);
            ...
            void SearchResultPoiController::OnSearchResultImageLoaded(const SearchResultPoiViewImageDownloadCompletedMessage& message)
            {
                ...
                if (m_viewModel.IsOpen())
                {
                    std::string imageUrl = "";
                    std::string ratingImageUrl = "";
                    Search::Yelp::TryParseImageDetails(m_viewModel.GetSearchResultModel(), imageUrl, ratingImageUrl);
