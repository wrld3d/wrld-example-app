...
namespace ExampleApp
{
    namespace SearchResultPoi
    {
        namespace SdkModel
        {
            SearchResultPoiViewOpenedMessageHandler::SearchResultPoiViewOpenedMessageHandler(const std::shared_ptr<ISearchResultPoiViewImageFetcher>& searchResultPoiViewImageFetcher,
