...
(cd $pathToProjectDir && xcodeBuild -exportArchive  -exportOptionsPlist ../../build-scripts/ios/ExportOptions/ExportOptions.plist -allowProvisioningUpdates -archivePath "$archivePath" -exportPath .)
if [ $? -ne 0 ]; then
