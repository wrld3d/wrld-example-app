...
public class PoiCreationButtonView implements View.OnClickListener 
{	
	...
	public PoiCreationButtonView(MainActivity activity, long nativeCallerPointer)
	{
		m_activity = activity;
	...
	public void onClick(View view) 
	{
		m_activity.runOnNativeThread(new Runnable()
		{
			public void run()
			{
				PoiCreationJniMethods.StartButtonPressed(m_nativeCallerPointer);
			}
		});
	}
