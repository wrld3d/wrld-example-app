...
public class IndoorAtlasManager implements IALocationListener, IARegion.Listener
{
    ...
    public IndoorAtlasManager(MainActivity activity, long nativeCallerPointer)
    {
    ...
    public void StartUpdatingLocation(final String apiKey, final String apiSecret, final String planId)
    {
