...
public class AboutPageView implements View.OnClickListener
{
    ...
    private ImageView m_wrldLogoImage = null;
    ...
    public AboutPageView(MainActivity activity, long nativeCallerPointer)
    {
        ...
        m_wrldLogoImage = (ImageView)m_view.findViewById(R.id.about_page_wrld_logo);
        ...
        m_wrldLogoImage.setOnLongClickListener(new View.OnLongClickListener()
        {
            @Override
