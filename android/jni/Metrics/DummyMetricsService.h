...
namespace ExampleApp {
    namespace Metrics {
        ...
        public:
            ...
            void BeginTimedEvent(const std::string &eventString, const std::string &key,
                                 const std::string &value);

            void EndTimedEvent(const std::string &eventString);

            void EndTimedEvent(const std::string &eventString, const std::string &key,
                               const std::string &value);

            void SetPosition(const double latitude, const double longitude,
                             const double horizontalAccuracy, const double verticalAccuracy);
