...
namespace ExampleApp
{
    ...
    {
    	PoiCreationConfirmationViewController::PoiCreationConfirmationViewController(
    	...
    	, m_pOnScreenStateChangedCallback(Eegeo_NEW((
    	    			Eegeo::Helpers::TCallback2<PoiCreationConfirmationViewController, ScreenControlViewModel::IScreenControlViewModel&, float>))(this, &PoiCreationConfirmationViewController::OnScreenStateChangedCallback))
    	{
			...
			jstring strClassName = env->NewStringUTF("com.eegeo.poicreation.PoiCreationConfirmationView");
    	...
    	void PoiCreationConfirmationViewController::HandleCancelSelected()
    	{
    		m_model.SetCreationStage(ExampleApp::PoiCreation::Inactive);
    	}

    	void PoiCreationConfirmationViewController::HandleConfirmSelected()
		{
    		m_model.SetCreationStage(ExampleApp::PoiCreation::Details);
			m_viewModel.RemoveFromScreen();
			m_detailsViewModel.Open();
		}

    	void PoiCreationConfirmationViewController::OnScreenStateChangedCallback(ScreenControlViewModel::IScreenControlViewModel& viewModel, float& onScreenState)
    	{
			AndroidSafeNativeThreadAttachment attached(m_nativeState);
			JNIEnv* env = attached.envForThread;
