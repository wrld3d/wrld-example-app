...
include $(CLEAR_VARS)
LOCAL_MODULE    := httpxx-lib

LOCAL_CFLAGS += -march=armv6 -marm -mfloat-abi=softfp -mfpu=vfp -fexceptions

cppfiles := $(shell cd jni; find ./../libs/httpxx/libs/http-parser/ ./../libs/httpxx/code/ -type f  -iname "*.c*")
...
LOCAL_STATIC_LIBRARIES += httpxx-lib
