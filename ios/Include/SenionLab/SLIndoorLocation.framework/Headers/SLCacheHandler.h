...
/** 
 ...
 @param completion This block will be called after the Map Key is downloaded. If successful, NSError will be nil, otherwise NSError will contain the occuring error. See Error in Detailed description.
 */
...
/**
 ...
 @param customerId Your Customer ID (obtained from SenionLab).
 @param completion This block will be called after each Map Key is downloaded. If successful, NSError will be nil, otherwise NSError will contain the occuring error. See Error in Detailed description.
 */
