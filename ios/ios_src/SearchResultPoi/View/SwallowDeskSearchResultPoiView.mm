...
#include "SwallowDeskSearchResultPoiView.h"
#include "App.h"
#include "SwallowSearchParser.h"
#import "UIButton+DefaultStates.h"

@interface SwallowDeskSearchResultPoiView()<UIGestureRecognizerDelegate>
{
}
@end

@implementation SwallowDeskSearchResultPoiView
...
- (void) performDynamicContentLayout
{
    ...
    if(m_swallowDeskModel.GetEmployeeSubtitle() != ""
       || m_swallowDeskModel.GetWorkingGroup() != ""
       || m_swallowDeskModel.GetOfficeLocation() != ""
       || m_swallowDeskModel.GetDeskCode() != "")
    {
        ...
        if(m_swallowDeskModel.GetWorkingGroup() != "")
        {
        ...
        if(m_swallowDeskModel.GetOfficeLocation() != "")
        {
        ...
        if(m_swallowDeskModel.GetDeskCode() != "")
        {
...
- (void) setContent:(const ExampleApp::Search::SdkModel::SearchResultModel*)pModel
{
    ...
    m_swallowDeskModel = ExampleApp::Search::Swallow::SdkModel::SearchParser::TransformToSwallowDeskResult(m_model);
    ...
    self.pNameLabel.text = [NSString stringWithUTF8String:m_swallowDeskModel.GetEmployeeName().c_str()];
    ...
    self.pJobTitleLabel.text = [NSString stringWithUTF8String:(jobTitlePrefix + m_swallowDeskModel.GetEmployeeSubtitle()).c_str()];
    self.pWorkingGroupLabel.text = [NSString stringWithUTF8String:(workingGroupPrefix + m_swallowDeskModel.GetWorkingGroup()).c_str()];
    self.pOfficeLocationLabel.text = [NSString stringWithUTF8String:(officeLocationPrefix + m_swallowDeskModel.GetOfficeLocation()).c_str()];
    self.pDeskCodeLabel.text = [NSString stringWithUTF8String:(deskCodePrefix + m_swallowDeskModel.GetDeskCode()).c_str()];
...
{
//    if(url == m_swallowDeskModel.GetImageUrl())
//    {
