...
@class DecartaSearchResultPoiView;

@interface DecartaSearchResultPoiView : UIView<SearchResultPoiView>
{
...
@property (nonatomic, retain) UILabel* pGenericWebLinkContent;
