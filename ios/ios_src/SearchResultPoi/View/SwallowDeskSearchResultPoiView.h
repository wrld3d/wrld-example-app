...
@class SwallowDeskSearchResultPoiView;

@interface SwallowDeskSearchResultPoiView : UIView<SearchResultPoiView>
{
    float m_stateChangeAnimationTimeSeconds;
    ExampleApp::Search::SdkModel::SearchResultModel m_model;
    ExampleApp::Search::Swallow::SdkModel::SwallowDeskResultModel m_swallowDeskModel;
