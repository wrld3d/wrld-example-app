...
@class SwallowWorkingGroupSearchResultPoiView;

@interface SwallowWorkingGroupSearchResultPoiView : UIView<SearchResultPoiView>
{
    UIViewController* m_pController;
    
    float m_stateChangeAnimationTimeSeconds;
    ExampleApp::Search::SdkModel::SearchResultModel m_model;
    ExampleApp::Search::Swallow::SdkModel::SwallowWorkingGroupResultModel m_workingGroupModel;
