...
- (void) onClick:(UIButton *)sender
{
    ...
    NSString* alertMessage = [NSString stringWithFormat: @"The %@ app is built using the eeGeo maps SDK, a cross platform API for building engaging, customizable apps.", appName];
