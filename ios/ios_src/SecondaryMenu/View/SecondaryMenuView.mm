...
{
    return m_pSecondaryMenuInterop;
}

- (void) initialiseViews:(size_t)numberOfSections numberOfCells:(size_t)numberOfCells
{
    m_pSecondaryMenuInterop = Eegeo_NEW(ExampleApp::SecondaryMenu::View::SecondaryMenuViewInterop)(self);
...
- (void)dealloc
{
    ...
    Eegeo_DELETE m_pSecondaryMenuInterop;
