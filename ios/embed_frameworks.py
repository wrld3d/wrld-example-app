...
def embed_frameworks():
    project_file_name = 'ProjectSwallowApp.xcodeproj/project.pbxproj'
    link_phase_guid = '3A8D81F51F8E629100325BF3'
    embed_phase_guid = '3A8D81F61F8E629100325BF3'
    path = 'ios/Include'
    frameworks = [
        {
            'name': 'StepInsideSdk.framework',
            'guid': '3A8D81F31F8E629100325BF3',
            'embed_guid': '3A8D81F41F8E629100325BF3',
            'path_in_project': 'Include/SenionLab/StepInsideSdk.framework'
        },
        {
